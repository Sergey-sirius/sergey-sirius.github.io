...
завершается */. Блочные комментарии могут быть вложенными.
...
Внутри можно использовать кавычки для простых текстовых строк и $$ для разграничения фраг-
ментов SQL-команды, собираемой из отдельных строк. Если нужно взять в кавычки текст, который
включает $$, можно использовать $Q$, и так далее.
1173PL/pgSQL — проце-
дурный язык SQL
