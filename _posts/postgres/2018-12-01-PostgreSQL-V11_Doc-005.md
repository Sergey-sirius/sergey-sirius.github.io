...
рование с использованием наследования, выполните следующие действия:
1. Создайте «главную» таблицу, от которой будут наследоваться все «дочерние» таблицы. Главная
...
ной таблицей будет measurement со своим изначальным определением.
2. Создайте несколько «дочерних» таблиц, унаследовав их все от главной. Обычно в таких таблицах
...
3. Добавьте в дочерние таблицы неперекрывающиеся ограничения, определяющие допустимые
...
4. Для каждой дочерней таблицы создайте индекс по ключевому столбцу (или столбцам), а также
...
5. Мы хотим, чтобы наше приложение могло сказать INSERT INTO measurement ... и данные ока-
...
в главную таблицу.
6. Убедитесь в том, что параметр конфигурации constraint_exclusion не выключен в
...
создании новой таблицы с тем же именем функция снова будет работать.
